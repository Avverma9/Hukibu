  ...
  return (
    <>
      ...
      <form className="addcoarse-form" onSubmit={handleSubmit}>
        ...
        <div className="form-field-what">
          ...
          <input
            ...
            value={whatYouGet[0]}
            onChange={(e) =>
              setWhatYouGet([e.target.value, whatYouGet[1], whatYouGet[2]])
            }
          />
          <input
            type="text"
            ...
            value={whatYouGet[1]}
            onChange={(e) =>
              setWhatYouGet([whatYouGet[0], e.target.value, whatYouGet[2]])
            }
          />
          <input
            type="text"
            ...
            value={whatYouGet[2]}
            onChange={(e) =>
              setWhatYouGet([whatYouGet[0], whatYouGet[1], e.target.value])
            }
          />
      ...
      <div className="buttons">
         <button className="backarrow-btn" onClick={handleBack}>
        <TbArrowBackUp />
        Back
      </button> </div>
